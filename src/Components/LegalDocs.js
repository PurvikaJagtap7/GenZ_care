  ...
  return (
    <div className="legal-section-title">
      <h1 className="legal-siteTitle">
        <Link to="/">
          GenZ <span className="legal-siteSign">care</span>
        </Link>
      </h1>
      ...
      <div className="legal-text-content">
        ...
        <p className="legal-description">
          Welcome to GenZ Care, your trusted online healthcare platform. Our
        ...
        <p className="legal-description">
          When using GenZ Care, you agree to our Terms of Service. This
        ...
        <p className="legal-description">
          GenZ Care is designed to simplify healthcare access. You can choose
      ...
      <div className="legal-footer">
        <p>© 2023-2024 GenZ care. All rights reserved.</p>
      </div>
    </div>
  );
}
